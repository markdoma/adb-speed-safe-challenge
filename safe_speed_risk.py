...
def export_priority_segments(prioritized: pd.DataFrame, output_dir: Path) -> Path | None:
    ...
    export_cols = [
        ...
        for c in [
            ...
            "school_present",
            "market_present",
            "school_or_market_present",
            "transit_stop_present",
            "pedestrian_activity_present",
            "speed_sign_present",
            "school_context",
            "market_context",
            ...
            "speed_sign_visible",
            "sidewalk_present_factor",
            "crossing_present_factor",
            "school_context_factor",
            "market_context_factor",
            "school_or_market_context_factor",
            "transit_stop_context_factor",
            "pedestrian_activity_visible_factor",
